    ...
    <div class="main-views-form" style="background-color: white;height: 500px;margin-top: 0;width: 96%;display: flex;justify-content: center;">
      <el-form style="margin-top: 100px;height: 80%;">
        <div class="el-form-line">
          <el-form-item >
            <template #label>
              <span style="width: 250px;font-size: 16px;color: dodgerblue">代付订单失效时长(min):</span>
            </template>
        ...
        <div class="el-form-line" style="width: auto">
          <el-form-item >
            <template #label>
              <span style="width: 250px;font-size: 16px;color: dodgerblue">代付失败重试开关:</span>
            </template>
            <el-switch
                v-model="payingRetry"
                active-color="#13ce66"
        ...
        <div class="el-form-line">
          <el-form-item  class="large-label">
            <template #label>
              <span style="width: 250px;font-size: 16px;color: dodgerblue">代付通道匹配模式:</span>
            </template>
